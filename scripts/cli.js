...
const contractABI = require("../artifacts/contracts/Contractchain.sol/Contractchain.json").abi;

program
    .name("contractchain-cli")
    .description("CLI tool for Contractchain smart contract")
    .version("1.0.0");
